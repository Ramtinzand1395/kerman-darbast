...
const Firstdiv = () => {
  return (
    <div className="md:container md:mx-auto mx-2">
      ...
      <p className="my-5">
        شرکت تبری از سال 1395 فعالیت خود را در زمینه خدمات داربست فلزی در استان
        کرمان آغاز کرده و اکنون با بیش از 10 سال تجربه، یکی از پیشگامان این حوزه
        در شهرستان کرمان محسوب می‌شود. ما با بهره‌گیری از تیمی متخصص و متعهد،
        خدمات متنوعی در زمینه داربست فلزی ارائه می‌دهیم.
      </p>
      <p>
      ...
      <div className="my-5 flex flex-col items-start justify-around">
        ...
        <p className="my-5">
          نما , زیر بتن , دیوار برشی , چاهک آسانسور , حفاظ و چهار پایه , نور گیر
          و ...
        </p>
        <p className="my-5">
