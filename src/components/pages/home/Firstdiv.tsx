...
const Firstdiv = () => {
  return (
    <div className="container md:mx-auto mx-2 w-full">
      <h2 className="my-5 text-2xl md:text-4xl text-primary min-h-[48px]">
      ...
      <p className="my-5">
        ...
        بیش از 20 سال تجربه، یکی از پیشگامان این حوزه در شهرستان کرمان محسوب
        می‌شود. ما با بهره‌گیری از تیمی متخصص و متعهد، خدمات متنوعی در زمینه
        داربست فلزی ارائه می‌دهیم.
      </p>
      <p>
        اگر به دنبال یک شرکت حرفه‌ای برای نصب داربست فلزی در کرمان هستید، ما
        اینجا هستیم تا با بهترین خدمات و مناسب‌ترین قیمت‌ها نیاز شما را برطرف
        کنیم. تیم ما با تجربه‌ای چندین ساله در زمینه نصب داربست، تضمین می‌کند که
        پروژه شما در کوتاه‌ترین زمان و با رعایت استانداردهای ایمنی انجام شود.
      </p>
      <div className="my-5 flex flex-col items-start justify-around">
       
        <p className="my-5 font-bold">
        مجموعه ما با تخصص و تجربه در زمینه‌های مختلف، آماده ارائه خدمات به مشتریان در حوزه‌های نما، زیر بتن، دیوار برشی، چاهک آسانسور، حفاظ و چهارپایه، نورگیر و سایر پروژه‌های مشابه است.
        </p>
        <p className="my-5">
          پروژه‌های ساختمانی مانند ساخت و ساز یا بازسازی بناها پروژه‌های صنعتی
          از جمله کارخانه‌ها و مراکز تولیدی فعالیت‌های تبلیغاتی نظیر نصب
